...
namespace CarChanger.Common.Components
{
    ...
    public class MoveThisControl : MonoBehaviour
    {
        ...
        [Tooltip("Changes the axis of the control, if supported")]
        public bool ChangeAxis = false;
        [EnableIf(nameof(ChangeAxis))]
        public Vector3 Axis = Vector3.up;
        [Tooltip("Changes the limits of the control, if supported")]
        ...
        [Tooltip("Replaces the StaticInteractionArea colliders if provided")]
